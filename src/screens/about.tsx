...
const brands: IBrand[] = [
  {
    ...
    linkTwitter: '​https://twitter.com/f​ashionfusion?lang=de',
    linkWebsite: 'https://www.f​ashionfusion.telekom.com',
  },
  {
    image: imageKonig,
    name: 'KÖNIG SOUVENIR',
    ...
    linkWebsite: '​https://www.koenig-souvenir.com/',
  },
  {
    image: imageArivda,
    name: 'ARVIDA BYSTROM',
    ...
    line2: '',
    linkInstagram: 'https://www.instagram.com/arvidabystrom/?hl=en',
